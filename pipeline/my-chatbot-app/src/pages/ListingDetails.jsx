                                                    ...
                                                    <div className="space-y-2">
                                                        {floorplansInGroup.map(fp => (
                                                            <div key={fp.id} className="border border-gray-200 rounded-lg">
                                                                ...
                                                                <div
                                                                    className="grid grid-cols-5 gap-4 p-4 items-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-800 dark:text-gray-100 text-sm sm:text-base flex-wrap"
                                                                    onClick={() => fp.child_units.length > 0 && toggleFloorplan(fp.id)}
                                                                >
                                                                    ...
                                                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1 sm:gap-2">
                                                                        ...
                                                                        {expandedFloorplans[fp.id] ? <ChevronUp /> : <ChevronDown />}
                                                                    </div>
                                                                </div>

                                                                {/* Expanded Individual Units */}
                                                                {expandedFloorplans[fp.id] && fp.child_units.length > 0 && (
